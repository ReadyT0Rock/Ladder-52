...
function scriptsSliders () {
  return src('source/js/sliders.js')
...
function copySwiper () {
  return src('source/js/swiper-bundle.min.js')
  .pipe(dest('dist/js'))
};

function copyStyles () {
  return src('source/css/swiper-bundle.min.css')
  .pipe(dest('dist/css'))
};
...
exports.build = series(clean, images, svg, copyStyles, copySwiper, copySprite, copy, styles, html, scripts, scriptsSliders, server);
